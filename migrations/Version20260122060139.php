 ...
 */
final class Version20260122060139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD owner_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP owner_id, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
}
